...
public class LimitError {
    ...
    public LimitError() { object = new JSONObject(); }
    public LimitError(JSONObject json) { object = json; }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof LimitError)) return false;
        return object.equals(((LimitError)o).object);
    }
}