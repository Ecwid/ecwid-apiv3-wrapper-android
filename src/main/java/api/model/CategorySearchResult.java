...
public class CategorySearchResult {
    ...
    public CategorySearchResult() { object = new JSONObject(); }
    public CategorySearchResult(JSONObject json) { object = json; }
    ...
    public List<Category> getItems() {
        ...
        return val == null ? null : val == JSONObject.NULL ? null : new JsonArrayList<Category>((JSONArray) val) {
            protected Category read(Object val) {
                return val == JSONObject.NULL ? null : new Category((JSONObject) val);
            }

            protected Object write(Category val) {
                return val == null ? JSONObject.NULL : val.asJson();
            }
        };
    }

    public void setItems(List<Category> val) {
        try {
            object.put("items", JsonUtil.asJsonArray(val, new JsonElementFactory<Category>() {
                public Object json(Category val) {
                    return val == null ? JSONObject.NULL : val.asJson();
                }
            }));
        } catch (JSONException ex) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof CategorySearchResult)) return false;
        return object.equals(((CategorySearchResult)o).object);
    }
}