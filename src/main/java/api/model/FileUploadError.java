...
public class FileUploadError {
    ...
    public FileUploadError() { object = new JSONObject(); }
    public FileUploadError(JSONObject json) { object = json; }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof FileUploadError)) return false;
        return object.equals(((FileUploadError)o).object);
    }
}