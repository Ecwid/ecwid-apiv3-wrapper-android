...
public class AuthError {
    ...
    public AuthError() { object = new JSONObject(); }
    public AuthError(JSONObject json) { object = json; }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof AuthError)) return false;
        return object.equals(((AuthError)o).object);
    }
}