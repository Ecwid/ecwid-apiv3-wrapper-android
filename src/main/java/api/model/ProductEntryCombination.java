...
public class ProductEntryCombination {
    private JSONObject object;
    public ProductEntryCombination() { object = new JSONObject(); }
    public ProductEntryCombination(JSONObject json) { object = json; }
    ...
    public List<OptionValue> getCombination() {
        Object val = object.opt("combination");
    ...
    public void setCombination(List<OptionValue> val) {
        try {
            object.put("combination", JsonUtil.asJsonArray(val, new JsonElementFactory<OptionValue>() {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ProductEntryCombination)) return false;
        return object.equals(((ProductEntryCombination)o).object);
    }
}