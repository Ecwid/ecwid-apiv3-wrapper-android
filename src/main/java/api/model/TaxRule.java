...
public class TaxRule {
    ...
    public TaxRule() { object = new JSONObject(); }
    public TaxRule(JSONObject json) { object = json; }


    public String getZoneId() {
        Object val = object.opt("zoneId");
        return val == null ? null : JsonUtil.asString(val);
    }

    public void setZoneId(String val) {
        try {
            object.put("zoneId", JsonUtil.asJsonSingleton(val));
    ...
    public boolean equals(Object o) {
        ...
        return object.equals(((TaxRule)o).object);
    }
}