...
public class DeletedCustomerTO {
    private JSONObject object;
    public DeletedCustomerTO() { object = new JSONObject(); }
    public DeletedCustomerTO(JSONObject json) { object = json; }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof DeletedCustomerTO)) return false;
        return object.equals(((DeletedCustomerTO)o).object);
    }
}