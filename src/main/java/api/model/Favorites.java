...
public class Favorites {
    ...
    public Favorites() { object = new JSONObject(); }
    public Favorites(JSONObject json) { object = json; }
    ...
    public String getDisplayedCount() {
        Object val = object.opt("displayedCount");
        return val == null ? null : JsonUtil.asString(val);
    }

    public void setDisplayedCount(String val) {
        try {
            object.put("displayedCount", JsonUtil.asJsonSingleton(val));
        } catch (JSONException ex) {
            throw new IllegalArgumentException(ex.getMessage());
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        return object.equals(((Favorites)o).object);
    }
}