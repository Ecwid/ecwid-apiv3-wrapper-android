...
public class RetryError {
    ...
    public RetryError() { object = new JSONObject(); }
    public RetryError(JSONObject json) { object = json; }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof RetryError)) return false;
        return object.equals(((RetryError)o).object);
    }
}