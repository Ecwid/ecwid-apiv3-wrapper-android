...
public class OrderSearchResult {
    ...
    public OrderSearchResult() { object = new JSONObject(); }
    public OrderSearchResult(JSONObject json) { object = json; }
    ...
    public List<Order> getItems() {
        ...
        return val == null ? null : val == JSONObject.NULL ? null : new JsonArrayList<Order>((JSONArray) val) {
            protected Order read(Object val) {
                return val == JSONObject.NULL ? null : new Order((JSONObject) val);
            }

            protected Object write(Order val) {
                return val == null ? JSONObject.NULL : val.asJson();
            }
        };
    }

    public void setItems(List<Order> val) {
        try {
            object.put("items", JsonUtil.asJsonArray(val, new JsonElementFactory<Order>() {
                public Object json(Order val) {
                    return val == null ? JSONObject.NULL : val.asJson();
                }
            }));
        } catch (JSONException ex) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof OrderSearchResult)) return false;
        return object.equals(((OrderSearchResult)o).object);
    }
}