...
public class DeletedOrderTO {
    private JSONObject object;
    public DeletedOrderTO() { object = new JSONObject(); }
    public DeletedOrderTO(JSONObject json) { object = json; }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof DeletedOrderTO)) return false;
        return object.equals(((DeletedOrderTO)o).object);
    }
}